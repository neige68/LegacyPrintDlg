...
レジストリ操作でも行えますが、それを GUI 操作で簡単に行えるようにしま
した。
...
2. 「印刷ダイアログの種類」で「レガシー(旧型)」または「モダン(新型)」
   を選択し OK ボタンをクリック
...
- Windows スタートメニュー → 設定 → アプリ → インストールされている
  アプリ から LegacyPrintDlg を選択してアンインストール
...
- Ver.1.0.0 (2025/07/14) 初版リリース

- Ver.1.1.0 (2025/08/20) Vector 掲載用リリース
